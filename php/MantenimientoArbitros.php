...
<div class="jumbotron boxlogin" style = "width: 470px;"  >
    ...
    <a href="modificarArbitro.html"> <input type="submit" class="btn btn-success" style="height:35px width:75px;"  value="Editar"  />

		<a href="eliminarArbitro.html"> <input type="submit" class="btn btn-success" style="height:35px; width:75px;"  value="Eliminar">
